...
<body>
  <div class="settings">
    ...
    <div class="tabs">
      <button class="tab active" id="tab-barber">Diponibilidade</button>
      <button class="tab" id="tab-clients">Clientes</button>
    </div>
    ...
    <div class="content hidden" id="content-clients">
      <div id="lista-clientes" class="clientes-lista">
        <p style="text-align:center;color:#777;">Carregando clientes...</p>
      </div>
    </div>
  </div>

  <script src="../../src/script/listarClientes.js"></script>
